...
public class LineChart12 {

    public static String genLineChart(HttpSession session)throws Exception{

        // 访问量统计
        TimeSeries timeSeries=new TimeSeries("数据折线图展示", Month.class);
        // 添加数据
        ...
        timeSeries.add(new Month(13,2013), 1600);
        // 定义时间序列的集合
        TimeSeriesCollection lineDataset=new TimeSeriesCollection();
        lineDataset.addSeries(timeSeries);

        JFreeChart chart=ChartFactory.createTimeSeriesChart("访问量统计时间折线图", "次数", "访问量", lineDataset, true, true, true);
