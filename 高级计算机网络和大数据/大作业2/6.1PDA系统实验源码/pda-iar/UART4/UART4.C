...
unsigned char LED_BLUE_Flag;
unsigned char LED_RED_Flag;
unsigned char LED_RED_tick;
unsigned char LED_BLUE_tick;
unsigned char LED_RED_TIME_OK=0;

unsigned char BEEP_Flag;
unsigned char BEEP_tick;
unsigned char BEEP_TIME_OK=0;
...
{
  if ( Uart4_OV == 1) /* 5Ms 时间到 */
  { 
          LED_BLUE_Flag=1;
          Uart4_OV = 0;
          Data_Um402();   //数据处理
          Watchdog();
  //	GPIO_WriteBit(GPIOA, GPIO_Pin_1,(BitAction)((1-GPIO_ReadOutputDataBit(GPIOA, GPIO_Pin_1))));  /* LED1 取反 */  
  } 
}
