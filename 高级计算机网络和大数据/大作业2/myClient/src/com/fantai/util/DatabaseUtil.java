...
public class DatabaseUtil {
    ...
    private static String dbUrl = "jdbc:mysql://localhost:3306/fantainb1?autoReconnect=true&amp;autoReconnectForPools=true;useSSL=false";// 数据库地址
    private static String dbUser = "root";// 用户名
    private static String dbPass = "199628"; // 用户密码
